defmodule ChurchWeb.Resolvers.StripeResolver do
  alias Church.Api.StripeApi

  def make_offering(_, %{payment_method_id: payment_method_id, email: email, amount: amount, church_id: church_id}, _) do
